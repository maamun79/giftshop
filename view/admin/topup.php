            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-bordered" cellspacing="0" data-provide="datatables" data-server="<?=MI_BASE_URL;?>admin/actions.php" data-identifier="get_topups">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Thumb</th>
